...
var resultName = flag.String("name", "Storage", "Name of result structure")
var importType = flag.String("import", "", "Custom import for type name")
...
func main() {
	...
	f, err := generate(".", *tpName, *pkName, *resultName, getCodec(*codec), key, *importType)
	if err != nil {
		panic(err)
	}
	data := &bytes.Buffer{}
...
func generate(dirName, typeName string, pkgName, resultName string, codec Codec, key Keyer, typeImport string) (*jen.File, error) {
	var file *jen.File

	file = jen.NewFile(pkgName)

	file.HeaderComment("Code generated by typedstorage -type " + typeName + " -name " + resultName + " -import \"" + typeImport + "\"" + ". DO NOT EDIT.")
